...
<div class="container-fluid bg-dark css-container mt-5 text-white">
    ...
    <form action="funcionario-activies\login.php" method="POST" class="mt-3 m-5 center">
    ...
    <div class="row">
      <div class="col mt-4">
           <p>Não é cadastrado?</p><a href="funcionario.php">Clique aqui.</a>
      </div>
    </div>
    </form>
    <div class="row center">
      <div class="col mt-4">
           <button class="btn btn-light" href="login-funcionario.php"><a href="index.php">Login de Cliente</a></button>
      </div>
    </div>
    </div>
