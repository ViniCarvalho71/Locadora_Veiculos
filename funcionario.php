...
<head>
    ...
    <form action="funcionario-activies/insert.php" method="POST" class="mt-3 m-5">
    <div class="row">
    <div class="col-4">
    ...
    <div class="row">
        <div class="col-5">
        <label for="email" class="form-label" >Chapa</label>
        <input type="number" class="form-control " name="chapa" aria-describedby="email" placeholder="Chapa">
        </div>
        </div>
        <div class="row">
        <div class="col-8">
        <label for="usuario" class="form-label" >Usuário</label>
        <input type="text" class="form-control " name="usuario" aria-describedby="usuario" placeholder="Usuário">
        </div>
        <div class="col-4">
